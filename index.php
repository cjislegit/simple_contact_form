 ...
 if(isset($_POST["submit"])) {
    ...
    if(!array_filter($errors)){
     ...
     if(mysqli_query($conn, $sql)) {
      ...
      header("Location: details.php?=$new_id");
...
<?php require_once("templates/header.php") ?>
    <div class="new-user">
        ...
        <form  method="POST">
            ...
            <label>Comment:</label>
            <textarea id="comment" name="comment" cols="30" rows="10" value="<?php echo htmlspecialchars($_POST["comment"] ?? "") ?>"><?php echo htmlspecialchars($_POST["comment"] ?? "") ?></textarea>
